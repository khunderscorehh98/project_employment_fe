<template>
    <div>
      <v-container>
        <!-- <icon name="login" /> -->
        <div v-html="loginSvg" class="square-svg"></div>
        <!-- Login -->
        <div v-show="field == 1">
          <v-row align="center">
